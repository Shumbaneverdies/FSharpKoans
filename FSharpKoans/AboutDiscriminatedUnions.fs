...
module ``08: The Good Kind of Discrimination`` = 
    ...
    let ``02 Creating & pattern-matching a discriminated union`` () = 
        let randomOpinion degree =
            ...
            | _ -> "A thinker, eh?"
        randomOpinion (BSc (EarthScience, ComputerScience)) |> should equal "Good choice!"
        randomOpinion (BSc (EarthScience,Mathematics)) |> should equal "!!SCIENCE!!"
 ...
 //           | Empty -> 0
  ...
  //     let p=BinaryTree("YO",BinaryTree,a)
       
       
    //   let a = BinaryTree ("a",  // <-- you may want to spread this over multiple lines and/or let-bindings ...!
